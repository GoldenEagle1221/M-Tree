...
os.system('echo "Modified content for L1.txt" >> L1.txt')
new_top_hash = merkle_tree(files)
print('New top hash:', new_top_hash)

os.system('echo "Modified content for L2.txt" >> L2.txt')
new_top_hash = merkle_tree(files)
print('New top hash:', new_top_hash)

os.system('echo "Modified content for L3.txt" >> L3.txt')
new_top_hash = merkle_tree(files)
print('New top hash:', new_top_hash)

os.system('echo "Modified content for L4.txt" >> L4.txt')
new_top_hash = merkle_tree(files)
print('New top hash:', new_top_hash)
